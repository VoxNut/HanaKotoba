    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('japanese_level', models.CharField(choices=[('N5', 'Beginner (N5)'), ('N4', 'Elementary (N4)'), ('N3', 'Intermediate (N3)'), ('N2', 'Advanced (N2)'), ('N1', 'Expert (N1)')], default='N5', max_length=10)),
                ('daily_goal', models.IntegerField(default=20, help_text='Number of items to review daily')),
